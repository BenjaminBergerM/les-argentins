...
.project-banner { background: url("{{ asset('images/projects/3/header_img.png') }}") no-repeat center; }
...
<section class="row mt-2 mt-sm-5" style="max-height: 800px; overflow: hidden;">
